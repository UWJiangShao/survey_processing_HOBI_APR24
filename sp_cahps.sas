...
%let Full_Path_And_File_Name 	= K:\TX-EQRO\Research\Member_Surveys\THLC\STARPLUS_2023\case_mix_output\df_format_all_quota_sp.sas7bdat;
%let QuotaVariable 			 			  =  &quota_name;
%let Suffix					 			  =  _&quota_name;
%let OutputFolder 			 			  =  K:\TX-EQRO\Research\Member_Surveys\THLC\STARPLUS_2023\case_mix_output\result\quota_all\;
%let pvalue = 0.05; 
