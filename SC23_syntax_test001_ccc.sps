...
GET FILE = "\\fed-ad.ufl.edu\T001\user\mydocs\jiang.shao\Desktop\star_child\ccc_cohort_23.sav" .
dataset name data_file WINDOW= FRONT.

DEFINE  !qlist()  PHI_Plan_Name  PHI_SA_Name  Sex  Race  !ENDDEFINE .
DEFINE  !SYear()  2023  !ENDDEFINE .
DEFINE  !surveyPopulation()  "STARChild_CCC"  !ENDDEFINE .
DEFINE  !weightby()  1  !ENDDEFINE .
DEFINE  !sampledBy()  PHI_Plan_Code  !ENDDEFINE .
DEFINE  !LD() 30 !ENDDEFINE .
DEFINE  !OutDir()  "\\fed-ad.ufl.edu\T001\user\mydocs\jiang.shao\Desktop\star_child\STARChild_2023\STARChild_CCC_population\output"  !ENDDEFINE .
