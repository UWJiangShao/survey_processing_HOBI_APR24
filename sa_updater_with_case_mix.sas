/* STAR Adult Case Mix Updater */ 
/* Dont mix use among programs, as the 
...
proc import out=unadj_rate
	datafile = "K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\thlc_output\STARAdult_2023_unadjusted.csv"
	dbms = csv replace;
	guessingrows= max; 
run;
...
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_01.xlsx", quota_01); 
%update_rates (quota_01);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_02.xlsx", quota_02); 
%update_rates(quota_02);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_03.xlsx", quota_03); 
%update_rates(quota_03);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_04.xlsx", quota_04); 
%update_rates(quota_04);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_05.xlsx", quota_05); 
%update_rates(quota_05);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_06.xlsx", quota_06); 
%update_rates(quota_06);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_07.xlsx", quota_07); 
%update_rates(quota_07);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_08.xlsx", quota_08); 
%update_rates(quota_08);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_09.xlsx", quota_09); 
%update_rates(quota_09);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_10.xlsx", quota_10); 
%update_rates(quota_10);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_11.xlsx", quota_11); 
%update_rates(quota_11);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_12.xlsx", quota_12); 
%update_rates(quota_12);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_13.xlsx", quota_13); 
%update_rates(quota_13);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_14.xlsx", quota_14); 
%update_rates(quota_14);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_15.xlsx", quota_15); 
%update_rates(quota_15);
%import_excel("K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\case_mix_output\df_format_all_quota_sa_out_quota_16.xlsx", quota_16); 
%update_rates(quota_16);

/* no not-matching --- great, no not matched on Apr 26 result */ 
...
proc export data=work.adjusted_final
	outfile= "K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\STARAdult_2023_adjusted.xlsx"
	dbms=xlsx replace; 
run; 
