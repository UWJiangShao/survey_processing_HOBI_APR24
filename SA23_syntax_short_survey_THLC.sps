...
GET FILE = "K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\STAR Adult ARC 2023_Completes.sav" .
dataset name data_file WINDOW= FRONT.

DEFINE  !qlist()  PlanName  ServiceArea  Sex  Race  !ENDDEFINE .
DEFINE  !SYear()  2023  !ENDDEFINE .
DEFINE  !surveyPopulation()  "STARAdult"  !ENDDEFINE .
DEFINE  !weightby()  CompWeight  !ENDDEFINE .
DEFINE  !sampledBy()  PlanCode  !ENDDEFINE .
DEFINE  !LD() 30 !ENDDEFINE .

DEFINE  !OutDir()  "K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\thlc_output"  !ENDDEFINE .
...
GET DATA 
   /TYPE= XLSX
   /FILE= "K:\TX-EQRO\Research\Member_Surveys\THLC\STARAdult_2023\STAR_Adult_23_2303.xlsx"
   /SHEET= INDEX 1
   /CELLRANGE= RANGE "A1:V93095" .
